...
import { BarChart3, CheckCircle2, Clock, ClipboardList, Download, ListTodo, Plus, PlusCircle } from 'lucide-react';
...
const Dashboard: React.FC = () => {
  ...
  const { reminders, upcomingReminders, overdueReminders, addReminder } = useReminderContext();
  ...
  const handleGenerateReport = () => {
    ...
    // Save the PDF
    const fileName = `intellitask-dashboard-report-${format(new Date(), 'yyyy-MM-dd')}.pdf`;
    doc.save(fileName);
      ...
      <div className="page-container">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Welcome back, {user?.name || 'User'}! Here's an overview of your tasks and reminders.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <AnalyticsCard
            ...
            trend={{
              value: analytics.totalTasks ? Math.round((analytics.completedTasks / analytics.totalTasks) * 100) : 0,
              isPositive: true,
            }}
          />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <Card className="glass-card overflow-hidden">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-lg font-medium">Tasks Due Today</CardTitle>
              <Link to="/tasks">
            ...
            <CardContent>
              {todayTasks.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <Button variant="outline" onClick={() => setShowNewTask(true)}>
            ...
            <CardContent>
              {upcomingReminders.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <Button variant="outline" onClick={() => setShowNewReminder(true)}>
                    <Plus className="h-4 w-4 mr-2" />
                    Add Reminder
                  </Button>
                </div>
            ...
            <CardContent>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm font-medium">
                  {analytics.totalTasks ? Math.round((analytics.completedTasks / analytics.totalTasks) * 100) : 0}%
                </span>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4 text-center">
                <div>
                  <span className="text-3xl font-bold block">{analytics.completedTasks}</span>
                  <span className="text-sm text-muted-foreground">Completed</span>
                </div>
                <div>
                  <span className="text-3xl font-bold block">{analytics.pendingTasks}</span>
          ...
          <Card className="glass-card overflow-hidden">
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Button variant="outline" className="w-full justify-start" onClick={() => setShowNewTask(true)}>
